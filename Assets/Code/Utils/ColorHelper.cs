...
public class ColorHelper
{
	...
	public const string NguiLbl_Color_Yellow = "[FFFF00]";
	public const string NguiLbl_Color_Black = "[000000]";
	public const string NguiLbl_Color_Purple = "[FF22FF]";
}